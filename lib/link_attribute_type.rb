...
class LinkAttributeType
    ...
    # @attribute
    # @return [LinkType, nil]
    belongs_to :parent, LinkAttributeType

    # @attribute
    # @return [Integer, nil]
    property :root_id, Integer, :field => 'root'

    # @attribute
    # @return [LinkType, nil]
    belongs_to :root, LinkAttributeType

    # @attribute
    # @return [Integer]
    property :child_order, Integer, :required => true, :default => 0
